...
namespace RedeSocial.Migrations
{
    ...
    [Migration("20250716042258_AmizadeAjuste")]
    partial class AmizadeAjuste
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RedeSocial.Domain.Entities.Amizade", b =>
                {
                    ...
                    b.HasOne("RedeSocial.Domain.Entities.AmizadePendente", "Pedido")
                        .WithMany()
                    ...
                    b.HasOne("RedeSocial.Domain.Entities.Usuario", null)
                        .WithMany("AmigosEnviados")
                        .HasForeignKey("UsuarioId1");

                    b.HasOne("RedeSocial.Domain.Entities.Usuario", null)
                        .WithMany("AmigosRecebidos")
            ...
            modelBuilder.Entity("RedeSocial.Domain.Entities.Usuario", b =>
                {
                    b.Navigation("AmigosEnviados");

                    b.Navigation("AmigosRecebidos");
                });
