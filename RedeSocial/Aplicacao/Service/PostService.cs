...
namespace RedeSocial.Aplicacao.Service
{
    public class PostService
    {
        ...
        public PostService (IPostRepository postRepository, IComentarioRepository comentarioRepository, IAuthService authService, IMapper mapper, IAmizadeRepository amizadeRepository)
        {
